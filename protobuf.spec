...
Source0  : https://github.com/google/protobuf/archive/v3.6.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1530939344
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libprotobuf-lite.so.16
/usr/lib64/libprotobuf-lite.so.16.0.0
/usr/lib64/libprotobuf.so.16
/usr/lib64/libprotobuf.so.16.0.0
/usr/lib64/libprotoc.so.16
/usr/lib64/libprotoc.so.16.0.0
