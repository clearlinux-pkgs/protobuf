...
export LANG=C
export SOURCE_DATE_EPOCH=1493489147
...
/usr/include/google/protobuf/compiler/profile.pb.h
/usr/include/google/protobuf/compiler/profile.proto
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libprotobuf-lite.so.13
/usr/lib64/libprotobuf-lite.so.13.0.0
/usr/lib64/libprotobuf.so.13
/usr/lib64/libprotobuf.so.13.0.0
/usr/lib64/libprotoc.so.13
/usr/lib64/libprotoc.so.13.0.0
