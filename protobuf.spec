...
Source0  : https://github.com/protocolbuffers/protobuf/releases/download/v23.4/protobuf-23.4.tar.gz
...
Patch1: 0001-pep517-workaround.patch
Patch2: 0002-soversion-fix.patch
Patch3: 0003-Use-more-modern-c.patch
Patch4: backport-handle-none.patch
...
%prep
%setup -q -n protobuf-23.4
cd %{_builddir}/protobuf-23.4
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1690985566
mkdir -p clr-build
pushd clr-build
...
pushd python
LDFLAGS+=" -L../clr-build" PROTOC=../clr-build/protoc python3 -m build --wheel --no-isolation
popd
## build_append end
%install
export SOURCE_DATE_EPOCH=1690985566
...
/usr/include/google/protobuf/arena_config.h
...
/usr/lib64/libprotobuf-lite.so.23.4.0
/usr/lib64/libprotobuf.so.23
/usr/lib64/libprotobuf.so.23.4.0
/usr/lib64/libprotoc.so.23
/usr/lib64/libprotoc.so.23.4.0
