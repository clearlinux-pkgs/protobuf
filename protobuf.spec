...
Source0  : https://github.com/protocolbuffers/protobuf/releases/download/v21.6/protobuf-all-21.6.tar.gz
...
%prep
%setup -q -n protobuf-21.6
cd %{_builddir}/protobuf-21.6
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a protobuf-21.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663346891
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libprotobuf-lite.so.32.0.6
/usr/lib64/glibc-hwcaps/x86-64-v3/libprotobuf.so.32
/usr/lib64/glibc-hwcaps/x86-64-v3/libprotobuf.so.32.0.6
/usr/lib64/glibc-hwcaps/x86-64-v3/libprotoc.so.32
/usr/lib64/glibc-hwcaps/x86-64-v3/libprotoc.so.32.0.6
/usr/lib64/libprotobuf-lite.so.32
/usr/lib64/libprotobuf-lite.so.32.0.6
/usr/lib64/libprotobuf.so.32
/usr/lib64/libprotobuf.so.32.0.6
/usr/lib64/libprotoc.so.32
/usr/lib64/libprotoc.so.32.0.6
