...
%prep
%setup -q -n protobuf-3.11.2
cd %{_builddir}/protobuf-3.11.2
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
cp %{_builddir}/protobuf-3.11.2/third_party/googletest/googlemock/LICENSE %{buildroot}/usr/share/package-licenses/protobuf/5a2314153eadadc69258a9429104cd11804ea304
cp %{_builddir}/protobuf-3.11.2/third_party/googletest/googlemock/scripts/generator/LICENSE %{buildroot}/usr/share/package-licenses/protobuf/1d4719e04eaa4909ab5a59ef5cb04d2a5517716e
cp %{_builddir}/protobuf-3.11.2/third_party/googletest/googletest/LICENSE %{buildroot}/usr/share/package-licenses/protobuf/5a2314153eadadc69258a9429104cd11804ea304
%make_install
...
/usr/lib64/libprotobuf-lite.so.22.0.2
/usr/lib64/libprotobuf.so.22
/usr/lib64/libprotobuf.so.22.0.2
/usr/lib64/libprotoc.so.22
/usr/lib64/libprotoc.so.22.0.2
