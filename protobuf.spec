...
Source0  : https://github.com/protocolbuffers/protobuf/releases/download/v21.8/protobuf-all-21.8.tar.gz
...
%prep
%setup -q -n protobuf-21.8
cd %{_builddir}/protobuf-21.8
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
pushd ..
cp -a protobuf-21.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666735905
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libprotobuf-lite.so.32.0.8
/usr/lib64/glibc-hwcaps/x86-64-v3/libprotobuf.so.32
/usr/lib64/glibc-hwcaps/x86-64-v3/libprotobuf.so.32.0.8
/usr/lib64/glibc-hwcaps/x86-64-v3/libprotoc.so.32
/usr/lib64/glibc-hwcaps/x86-64-v3/libprotoc.so.32.0.8
/usr/lib64/libprotobuf-lite.so.32
/usr/lib64/libprotobuf-lite.so.32.0.8
/usr/lib64/libprotobuf.so.32
/usr/lib64/libprotobuf.so.32.0.8
/usr/lib64/libprotoc.so.32
/usr/lib64/libprotoc.so.32.0.8
