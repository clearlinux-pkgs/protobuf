...
Source0  : https://github.com/protocolbuffers/protobuf/releases/download/v3.12.4/protobuf-all-3.12.4.tar.gz
...
%prep
%setup -q -n protobuf-3.12.4
cd %{_builddir}/protobuf-3.12.4
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596513564
...
cp %{_builddir}/protobuf-3.12.4/LICENSE %{buildroot}/usr/share/package-licenses/protobuf/1b5a14d06dd784e88dadc5c68344be2dc13875b6
cp %{_builddir}/protobuf-3.12.4/third_party/googletest/googlemock/LICENSE %{buildroot}/usr/share/package-licenses/protobuf/5a2314153eadadc69258a9429104cd11804ea304
cp %{_builddir}/protobuf-3.12.4/third_party/googletest/googlemock/scripts/generator/LICENSE %{buildroot}/usr/share/package-licenses/protobuf/1d4719e04eaa4909ab5a59ef5cb04d2a5517716e
cp %{_builddir}/protobuf-3.12.4/third_party/googletest/googletest/LICENSE %{buildroot}/usr/share/package-licenses/protobuf/5a2314153eadadc69258a9429104cd11804ea304
%make_install
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libprotobuf-lite.so.23
/usr/lib64/libprotobuf-lite.so.23.0.4
/usr/lib64/libprotobuf.so.23
/usr/lib64/libprotobuf.so.23.0.4
/usr/lib64/libprotoc.so.23
/usr/lib64/libprotoc.so.23.0.4
